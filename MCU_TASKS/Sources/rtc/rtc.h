...
/*Reading the flags in the rtc in low power mode is unsafe as it nullifies the alarm bits(P 36 in the CD00127116 manual section 3.5).
  Here is an implementation of a safe flag reading function that takes into consideration this behavior and signals the program              .
